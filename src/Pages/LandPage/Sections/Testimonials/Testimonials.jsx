...
const userTestimonials = [
  {
    avatar: <Avatar alt="Abdullah Alhasan" src="/static/images/avatar/1.jpg" />,
  ...
  {
    avatar: <Avatar alt="Mohammed Hattab" src="/static/images/avatar/2.jpg" />,
  ...
  {
    avatar: <Avatar alt="Kais Al Hursrom" src="/static/images/avatar/4.jpg" />,
    name: 'Kais Al Hursrom',
    occupation: 'Senior Engineer',
    testimonial:
