    ...
    <div className='ml-3 h-screen md:overflow-hidden overflow-auto md:hover:overflow-auto pb-10'>
      ...
      <>
        <div className='flex justify-between items-center'>
          <Link to="/" onClick={() =>{}} className='items-center ml-3 gap-3 mt-4 flex text-xl font-extrabold tracking-tight dark:text-white text-slate-900'>
          <SiShopware />
          Shoopy
          </Link>
          <TooltipComponent 
            ...
            <button type='button' onClick={handleCloseSideBar} className='text-xl rounded-full p-3 hover:bg-light-gray mt-4 md:hidden block'>
