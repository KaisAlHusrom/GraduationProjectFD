...
export const transformElementTypeToDesignStructure = (data, parentElement = null) => {
    ...
    if (data.children && data.children.length > 0) {
        transformedElement.children = data.children.map(child => transformElementTypeToDesignStructure(child, transformedElement));
    }
